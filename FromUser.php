    ...
    <div class="container-fluid">
      <div class="row mt-5 ">
        ...
        while($row = mysqli_fetch_assoc($res)){
            ...
            echo "<a href='ToUser.php?id=".$row['id']."' style='text-decoration: none; font-size: medium;' 
                    data-bs-toggle='tooltip' data-bs-placement='top' 
                    title='Do you want to Transfer money?,if yes, click' >Transfer <i class='fas fa-arrow-right  '></i>
                </a>
                </div>
            </div>";
        }
